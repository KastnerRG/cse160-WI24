...
#ifndef __GPUTK_MD5_H__
#define __GPUTK_MD5_H__
...
#define gpuTKMD5 MD5_buffer

#define HEX_STRING "0123456789abcdef" /* to convert to hex */

static void gpuTKMD5_sigToString(unsigned char signature[16], char *str,
                              int len) {
  unsigned char *sig_p;
  char *str_p, *max_p;
